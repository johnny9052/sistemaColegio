...
<html>
    <head>
        ...
        <script defer type="text/javascript" src="Resource/Script/Parameterization/BeerProduct.js"></script>
    </head>
    <body>
                ...
                <div class="boxModal container col s12" id="FormContainer">  
                    ...
                    <div class="input-field col s12">
                        <input id="txtName" name="name" type="text" value="" autocomplete="off" required
                               placeholder="Nombre tipo cerveza">                        
                    </div>
                    ...
                    <div class="input-field col s12">
                        <input id="txtAlcohol" name="alcohol" type="number" value="" autocomplete="off" 
                               placeholder="% Alcohol" step="0.1" required min="0" max="100">                        
                    </div>


                    <div class="input-field col s12">
                        <select id="selAmargor" name="amargor" required>
                            <option value="-1" selected> -- SELECCIONE NIVEL AMARGOR --</option>                            
                        </select>
                    </div>

                    <div class="input-field col s12">
                        <input id="txtPrice" name="price" type="number" value="" autocomplete="off" 
                               placeholder="Valor" step="0.1" required min="0">
                    </div>

                    <div class="input-field col s12">
                        <input id="txtCantidad" name="cantidad" type="number" value="" autocomplete="off" 
                               placeholder="Cantidad en ml" step="0.1" required min="0">
                    </div>
