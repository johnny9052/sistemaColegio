...
<html>
    <head>
        ...
        <script defer type="text/javascript" src="Resource/Script/Transaction/Expense.js"></script>
    </head>
    <body>
        ...
        <div id="ModalNew" class="boxModal modal">
            <div class="modal-content">
                ...
                <div class="boxModal container col s12" id="FormContainer">  
                    ...
                    <div class="input-field col s12">
                        <select id="selTypeExpense" name="typeexpense" required>
                            <option value="-1" selected> -- SELECCIONE EL TIPO DE GASTO --</option>                            
                        </select>
                    </div>
                    ...
                    <div class="input-field col s12">
                        <input id="txtValue" name="value" type="number" value="" autocomplete="off" required
                               placeholder="$ Ingrese valor en pesos Colombianos">                        
                    </div>

                    <div class="input-field col s12">
                        <input id="txtDateExpense" name="dateExpense" type="date" value="" autocomplete="off" required
                               placeholder="Fecha del gasto" class="datepicker">
