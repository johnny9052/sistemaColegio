...
<html>
    <head>
        ...
        <script defer type="text/javascript" src="Resource/Script/Inventory/Machinery.js"></script>
    </head>
    <body>
        <br>       
        ...
        <div id="ModalNew" class="boxModal modal">
            <div class="modal-content">
                ...
                <div class="boxModal container col s12" id="FormContainer">  
                    ...
                    <div class="input-field col s12">
                        <select id="selType" name="type" required>
                            <option value="-1" selected> -- SELECCIONE --</option>                            
                        </select>
                    </div>
                    <div class="input-field col s12">
                        <input id="txtCode" name="code" type="text" value="" autocomplete="off" required
                               placeholder="Codigo">
                        <!--                        <label class="messageInfo" for="name" data-error="Este campo es obligatorio" data-success=""></label>-->
                    </div>
                    <div class="input-field col s12">
                    ...
                    <div class="input-field col s12">
                        <input id="txtValue" name="value" type="number" value="" autocomplete="off" required
                               placeholder="Valor en pesos Colombianos" step="0.1">
                        <!--                        <label class="messageInfo" for="name" data-error="Este campo es obligatorio" data-success=""></label>-->
                    </div>
